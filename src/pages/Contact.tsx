    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[40vh] flex items-center bg-primary">
        <div className="container mx-auto px-4 pt-16">
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-primary-foreground">Contact Us</h1>
          <p className="text-primary-foreground/70 mt-4 max-w-lg text-lg">Let's start a conversation about your renovation project.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12">
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Textarea placeholder="Tell us about your project..." rows={5} required className="bg-card" />
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              {[
                ...
                { icon: MapPin, label: "Address", value: "123 Renovation St, Suite 100, New York, NY 10001" },
              ].map((item) => (
